...
export default async function HomePage() {
  const [featuredItems, categoryResponse] = await Promise.all([
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="relative aspect-square rounded-3xl shadow-[var(--shadow-wood)] overflow-hidden">
                <Image
                  src="/images/home-hero.jpg"
                  alt="Bún Đậu làng mơ bảng quảng cáo"
                  fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            {featuredItems.length === 0 && (
              <div className="md:col-span-2 lg:col-span-3 rounded-[var(--radius-card)] border border-brand-gray-200 bg-white p-8 text-center text-brand-gray-600">
      ...
      <section className="py-16 lg:py-24 bg-brand-beige/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
            ...
            {categories.length === 0 && (
              <div className="col-span-2 lg:col-span-4 rounded-[var(--radius-card)] border border-brand-gray-200 bg-white p-8 text-center text-brand-gray-600">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div className="bg-brand-gray-50 rounded-[var(--radius-card)] p-6 text-center">
              ...
              <p className="text-sm text-brand-gray-600">024.3456.7890</p>
            </div>
